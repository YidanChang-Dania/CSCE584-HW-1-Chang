"""
q7 Building a Neural Network Zoo
 From Scratch: The Long Short-Term Memory Network
"""
##### Imports #####
...
class LSTM:
    ...
    def forward(self, inputs):
        ...
        for q in range(len(inputs)):
            ...
            self.cell_states[q] = self.forget_gates[q] * self.cell_states[q - 1] + self.input_gates[q] * \
...
lstm = LSTM(input_size=char_size + hidden_size, hidden_size=hidden_size, output_size=char_size, num_epochs=1_000,
            learning_rate=0.05)
